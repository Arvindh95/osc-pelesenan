...
/**
 * Specialized wrapper for page components (with authentication protection)
 */
...
/**
 * Specialized wrapper for verified user components (requires identity verification)
 */
export const LazyVerifiedWrapper = ({ children }: { children: ReactNode }) => (
  <VerifiedRoute>
    <LazyWrapper fallback={<LoadingSkeleton />}>{children}</LazyWrapper>
  </VerifiedRoute>
);
...
/**
 * Specialized wrapper for admin components (with admin role protection)
 */
